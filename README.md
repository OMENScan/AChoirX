...
2. Run the default Windows, Linux, and MacOS AChoirX collectors as-is.  This is the fastest way to get started with AChoirX - Just download and run them.  No assembly required.
